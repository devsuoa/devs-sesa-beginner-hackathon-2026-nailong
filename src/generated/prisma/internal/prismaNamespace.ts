		...
		RiderProfile: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.RiderProfileCountAggregateOutputType>
						| number;
				};
			};
		};
...
export type RiderProfileScalarFieldEnum =
	(typeof RiderProfileScalarFieldEnum)[keyof typeof RiderProfileScalarFieldEnum];
 ...
 */
export type EnumDriverStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	"DriverStatus"
>;
 ...
 * Reference to a field of type 'DriverStatus[]'
 */
export type ListEnumDriverStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	"DriverStatus[]"
>;
