...
function TrackingContent() {
  ...
  useEffect(() => {
    ...
    const timer3 = setTimeout(() => {
        ...
        setEta(booking.estimatedArrival?.toTimeString() || "12");
    }, 4000);
  ...
  return (
    <div className="min-h-screen relative">
      <div className="w-full max-w-2xl mx-auto px-4 py-8 relative z-10">
          ...
          {driverAssigned ? (
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white font-semibold">{booking.driverId || "Captain Vega"}</p>
                  <p className="text-white/40 text-xs tracking-[0.15em]">ID: {booking.driverId|| "NX-001"}</p>
                  <p className="text-cyan-400 text-xs">⭐ {booking.driverId || 4.98} • {booking.driverId || 1200} rides</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">{booking.driverId || "SPC-0000"}</p>
                </div>
                <div>
        ...
        {/* AI Briefing Card */}
        <div className="relative rounded-lg border border-purple-500/20 bg-linear-to-r from-purple-500/5 to-blue-500/5 backdrop-blur-md p-6 mb-6">
        ...
        <div className="relative rounded-lg border border-white/20 bg-black/40 backdrop-blur-md p-6 mb-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between border-b border-white/10 pb-2">
              ...
              <span className="text-white font-semibold">{booking.originId}</span>
            </div>
            <div className="flex justify-between border-b border-white/10 pb-2">
              <span className="text-white/60 text-sm">To:</span>
              <span className="text-white font-semibold">{booking.destinationId}</span>
            </div>
            <div className="flex justify-between pt-2">
              <span className="text-white/60 text-sm">Distance:</span>
              <span className="text-cyan-400 font-semibold">{10} million km</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <Link href="/dashboard" className="flex-1">
            <button type="button" className="w-full h-12 flex items-center justify-center
